...
game_state.main.prototype = {
    ...
    table_classified: function(){//funzione per vedere la classifica
        
         $.getJSON(
            'Scores'
            , function(result) {

                var tabella_punteggio = $("#Scores > tbody");
                tabella_punteggio.empty();
                $(result).each(function(i, item) {
                    var tr_html =
                            ...
                            + "</tr>";
                    tabella_punteggio.append(tr_html);
                });
