...
!function(a, b) {
    ...
    b.InteractionManager = function() {
        ...
        if (a.parent && a.parent !== this && a.parent.removeChild(a), a.parent = this, this.children.push(a), this.stage) {
            var b = a;
            do
                b.interactive && (this.stage.dirty = !0), b.stage = this.stage, b = b._iNext;
            while (b)
        }
        ...
        if (void 0 !== a.parent && a.parent.removeChild(a), a.parent = this, this.stage) {
            var c = a;
            do
                c.interactive && (this.stage.dirty = !0), c.stage = this.stage, c = c._iNext;
            while (c)
        }
        ...
        if (b === this.children.length) {
            ...
            e = 0 === b ? this : this.children[b - 1].last;
        ...
        if (d._iNext = null, c._iPrev = null, this.stage) {
            var i = a;
            do
                i.interactive && (this.stage.dirty = !0), i.stage = null, i = i._iNext;
            while (i)
        }
        ...
        if (!(a.length < 1)) {
            ...
            for (var g, h, i, j, k, l = a.length, m = 1; l > m; m++)
                g = a[m], h = 4 * m, c = m < a.length - 1 ? a[m + 1] : g, e.y = -(c.x - d.x), e.x = c.y - d.y, i = 10 * (1 - m / (l - 1)), i > 1 && (i = 1), j = Math.sqrt(e.x * e.x + e.y * e.y), k = this.texture.height / 2, e.x /= j, e.y /= j, e.x *= k, e.y *= k, f[h] = g.x + e.x, f[h + 1] = g.y + e.y, f[h + 2] = g.x - e.x, f[h + 3] = g.y - e.y, d = g;
            ...
            for (var a, c, d, e = 1 / 0, f = -1 / 0, g = 1 / 0, h = -1 / 0, i = 0; i < this.graphicsData.length; i++) {
                ...
                if (a = j.points, k === b.Graphics.RECT) {
                    ...
                    for (var p = 0; p < a.length; p += 2)
                        c = a[p], d = a[p + 1], e = e > c - l ? c - l : e, f = c + l > f ? c + l : f, g = g > d - l ? d - l : g, h = d + l > h ? d + l : h
            }
        ...
        for (var d = a.worldAlpha, e = "", f = 0; f < a.graphicsData.length; f++) {
            ...
            if (c.strokeStyle = e = "#" + ("00000" + (0 | g.lineColor).toString(16)).substr(-6), c.lineWidth = g.lineWidth, g.type === b.Graphics.POLY) {
                ...
                (g.fillColor || 0 === g.fillColor) && (c.globalAlpha = g.fillAlpha * d, c.fillStyle = e = "#" + ("00000" + (0 | g.fillColor).toString(16)).substr(-6), c.fillRect(h[0], h[1], h[2], h[3])), g.lineWidth && (c.globalAlpha = g.lineAlpha * d, c.strokeRect(h[0], h[1], h[2], h[3]));
            else if (g.type === b.Graphics.CIRC)
                c.beginPath(), c.arc(h[0], h[1], h[2], 0, 2 * Math.PI), c.closePath(), g.fill && (c.globalAlpha = g.fillAlpha * d, c.fillStyle = e = "#" + ("00000" + (0 | g.fillColor).toString(16)).substr(-6), c.fill()), g.lineWidth && (c.globalAlpha = g.lineAlpha * d, c.stroke());
        ...
        if (0 !== d) {
            ...
            for (var e = 0; 1 > e; e++) {
                ...
                if (f.type === b.Graphics.POLY) {
                    ...
                    c.beginPath(), c.arc(g[0], g[1], g[2], 0, 2 * Math.PI), c.closePath();
            ...
            if (c = a.worldTransform, a.visible)
                if (a.renderable) {
                    if (a instanceof b.Sprite) {
                        ...
                        d.setTransform(c[0], c[3], c[1], c[4], c[2], c[5]), this.renderStrip(a);
                    else if (a instanceof b.TilingSprite)
                        d.setTransform(c[0], c[3], c[1], c[4], c[2], c[5]), this.renderTilingSprite(a);
                    else if (a instanceof b.CustomRenderable)
                        d.setTransform(c[0], c[3], c[1], c[4], c[2], c[5]), a.renderCanvas(this);
                    else if (a instanceof b.Graphics)
                        d.setTransform(c[0], c[3], c[1], c[4], c[2], c[5]), b.CanvasGraphics.renderGraphics(a, d);
        ...
        if (a.value && a.value.baseTexture && a.value.baseTexture.hasLoaded) {
            if (b.gl.activeTexture(b.gl["TEXTURE" + this.textureCount]), b.gl.bindTexture(b.gl.TEXTURE_2D, a.value.baseTexture._glTexture), a.textureData) {
                ...
                if (c.repeat && (f = b.gl.REPEAT, g = b.gl.REPEAT), b.gl.pixelStorei(b.gl.UNPACK_FLIP_Y_WEBGL, !1), c.width) {
                    ...
                    b.gl.texImage2D(b.gl.TEXTURE_2D, 0, h, b.gl.RGBA, b.gl.UNSIGNED_BYTE, a.value.baseTexture.source);
        ...
        for (var a, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = 0, s = this.head, t = this.verticies, u = this.uvs, v = this.colors; s; ) {
            if (s.vcount === b.visibleCount) {
                ...
                k = 8 * r, t[k + 0] = t[k + 1] = t[k + 2] = t[k + 3] = t[k + 4] = t[k + 5] = t[k + 6] = t[k + 7] = 0;
            r++, s = s.__next
        }
        ...
        do {
            if (A.visible)
                if (A instanceof b.Sprite)
                    d = A.texture.frame.width, e = A.texture.frame.height, f = A.anchor.x, g = A.anchor.y, h = d * (1 - f), i = d * -f, j = e * (1 - g), k = e * -g, l = !0;
                else if (A instanceof b.Graphics) {
        ...
        if (0 !== e.length) {
            ...
            for (l = e[0], m = e[1], n = e[2], o = e[3], r = - (m - o), s = l - n, F = Math.sqrt(r * r + s * s), r /= F, s /= F, r *= L, s *= L, G.push(l - r, m - s, O, P, Q, N), G.push(l + r, m + s, O, P, Q, N), d = 1; I - 1 > d; d++)
            ...
            for (l = e[2 * (I - 2)], m = e[2 * (I - 2) + 1], n = e[2 * (I - 1)], o = e[2 * (I - 1) + 1], r = - (m - o), s = l - n, F = Math.sqrt(r * r + s * s), r /= F, s /= F, r *= L, s *= L, G.push(n - r, o - s), G.push(O, P, Q, N), G.push(n + r, o + s), G.push(O, P, Q, N), H.push(K), d = 0; J > d; d++)
                H.push(K++);
            H.push(K - 1)
        }
        ...
        for (var e, f = 0; f < this.batchs.length; f++)
            e = this.batchs[f], e instanceof b.WebGLBatch ? this.batchs[f].render() : this.renderSpecial(e, a)
        ...
        for (var f, g, h, i, j = a.first; j._iNext && (!j.renderable || !j.__renderGroup); )
            j = j._iNext;
        var k = j.batch;
        ...
        if (m instanceof b.Sprite) {
            ...
            endBatch = m;
        if (k == endBatch)
            return k instanceof b.WebGLBatch ? k.render(f, h + 1) : this.renderSpecial(k, c), void 0;
        g = this.batchs.indexOf(k), i = this.batchs.indexOf(endBatch), k instanceof b.WebGLBatch ? k.render(f) : this.renderSpecial(k, c);
        for (var n = g + 1; i > n; n++)
            renderable = this.batchs[n], renderable instanceof b.WebGLBatch ? this.batchs[n].render() : this.renderSpecial(renderable, c);
    ...
    b.WebGLRenderGroup.prototype.handleFilterBlock = function(a, c) {
        var f = b.gl;
        if (a.open)
            a.data instanceof Array ? this.filterManager.pushFilter(a) : (e++, d.push(a), f.enable(f.STENCIL_TEST), f.colorMask(!1, !1, !1, !1), f.stencilFunc(f.ALWAYS, 1, 1), f.stencilOp(f.KEEP, f.KEEP, f.INCR), b.WebGLGraphics.renderGraphics(a.data, c), f.colorMask(!0, !0, !0, !0), f.stencilFunc(f.NOTEQUAL, 0, d.length), f.stencilOp(f.KEEP, f.KEEP, f.KEEP));
        else if (a.data instanceof Array)
        ...
        do
            d.__renderGroup = this, d.renderable && (this.insertObject(d, b, c), b = d), d = d._iNext;
        while (d != e)
    }, b.WebGLRenderGroup.prototype.removeDisplayObjectAndChildren = function(a) {
        if (a.__renderGroup == this) {
            a.last;
            do
                a.__renderGroup = null, a.renderable && this.removeObject(a), a = a._iNext;
            while (a)
        }
        ...
        if (a instanceof b.Sprite) {
            ...
            if (e instanceof b.Sprite) {
                if (g = e.batch, g && g.texture == a.texture.baseTexture && g.blendMode == a.blendMode)
            ...
            if (f)
                if (f instanceof b.Sprite) {
                    if (h = f.batch) {
                        if (h.texture == a.texture.baseTexture && h.blendMode == a.blendMode)
            ...
            a instanceof b.TilingSprite ? this.initTilingSprite(a) : a instanceof b.Strip && this.initStrip(a), this.insertAfter(a, e)
        ...
        if (c) {
            ...
            if (0 == e || e == this.batchs.length - 1)
                return this.batchs.splice(e, 1), c instanceof b.WebGLBatch && b.WebGLRenderer.returnBatch(c), void 0;
            if (this.batchs[e - 1]instanceof b.WebGLBatch && this.batchs[e + 1]instanceof b.WebGLBatch && this.batchs[e - 1].texture == this.batchs[e + 1].texture && this.batchs[e - 1].blendMode == this.batchs[e + 1].blendMode)
                return this.batchs[e - 1].merge(this.batchs[e + 1]), c instanceof b.WebGLBatch && b.WebGLRenderer.returnBatch(c), b.WebGLRenderer.returnBatch(this.batchs[e + 1]), this.batchs.splice(e, 2), void 0;
        ...
        if (b.EventTarget.call(this), this.width = 100, this.height = 100, this.scaleMode = c || b.BaseTexture.SCALE_MODE.DEFAULT, this.hasLoaded = !1, this.source = a, a) {
            if (this.source instanceof Image || this.source instanceof HTMLImageElement)
                if (this.source.complete)
                    this.hasLoaded = !0, this.width = this.source.width, this.height = this.source.height, b.texturesToUpdate.push(this);
                else {
                    var d = this;
        ...
        if (b.EventTarget.call(this), c || (this.noFrame = !0, c = new b.Rectangle(0, 0, 1, 1)), a instanceof b.Texture && (a = a.baseTexture), this.baseTexture = a, this.frame = c, this.trim = new b.Point, this.scope = this, a.hasLoaded)
            this.noFrame && (c = new b.Rectangle(0, 0, a.width, a.height)), this.setFrame(c);
        else {
            var d = this;
        ...
        if (this.width = a, this.height = c, b.gl) {
            ...
            this.frame.width = this.width, this.frame.height = this.height, this.renderer.resize(this.width, this.height)
            ...
            if (0 !== this._pluginsLength)
                for (this._p = 0; this._p < this._pluginsLength; this._p++)
                    if (this.plugins[this._p] === a)
                        return a.destroy(), this.plugins.splice(this._p, 1), this._pluginsLength--, void 0
        }, removeAll: function() {
            for (this._p = 0; this._p < this._pluginsLength; this._p++)
        ...
        this.game = a, "undefined" == typeof d && (d = a.world), this.name = e || "group", "undefined" == typeof f && (f = !1), f ? this._container = this.game.stage._stage : (this._container = new b.DisplayObjectContainer, this._container.name = this.name, d ? d instanceof c.Group ? d._container.addChild(this._container) : (d.addChild(this._container), d.updateTransform()) : (this.game.stage._stage.addChild(this._container), this.game.stage._stage.updateTransform())), this.type = c.GROUP, this.alive = !0, this.exists = !0, this.group = null, this._container.scale = new c.Point(1, 1), this.scale = this._container.scale, this.pivot = this._container.pivot, this.cursor = null
            ...
            if (a === b || !a.parent || !b.parent || a.group !== this || b.group !== this)
                return!1;
            var c = a._iPrev, d = a._iNext, e = b._iPrev, f = b._iNext, g = this._container.last._iNext, h = this.game.stage._stage;
            do
                h !== a && h !== b && (h.first === a ? h.first = b : h.first === b && (h.first = a), h.last === a ? h.last = b : h.last === b && (h.last = a)), h = h._iNext;
            while (h != g);
            ...
            if (a = a.split("."), "undefined" == typeof c && (c = !1), "undefined" == typeof d && (d = !1), e = e || 0, this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do
                    (c === !1 || c && f.alive) && (d === !1 || d && f.visible) && this.setProperty(f, a, b, e), f = f._iNext;
            ...
            if ("undefined" != typeof a) {
                ...
                if (this._container.children.length > 0 && this._container.first._iNext) {
                    ...
                    do
                        f = this.callbackFromArray(h, a, c), b && f ? (g = this.callbackFromArray(h, b, d), f && f.apply(g, e)) : f && f.apply(h, e), h = h._iNext;
            ...
            if (d.unshift(null), this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do
                    (c === !1 || c && e.exists) && (d[0] = e, a.apply(b, d)), e = e._iNext;
            ...
            do {
                ...
                for (var f = 0, g = this._container.children.length - 1; g > f; f++)
                    b == c.Group.SORT_ASCENDING ? this._container.children[f][a] > this._container.children[f + 1][a] && (this.swap(this.getAt(f), this.getAt(f + 1)), e = this._container.children[f], this._container.children[f] = this._container.children[f + 1], this._container.children[f + 1] = e, d = !0) : this._container.children[f][a] < this._container.children[f + 1][a] && (this.swap(this.getAt(f), this.getAt(f + 1)), e = this._container.children[f], this._container.children[f] = this._container.children[f + 1], this._container.children[f + 1] = e, d = !0)
            } while (d)
        }, iterate: function(a, b, d, e, f, g) {
            if (d === c.Group.RETURN_TOTAL && 0 === this._container.children.length)
                return 0;
            "undefined" == typeof e && (e = !1);
            var h = 0;
            if (this._container.children.length > 0 && this._container.first._iNext) {
                ...
                do {
                    if (i[a] === b && (h++, e && (g[0] = i, e.apply(f, g)), d === c.Group.RETURN_CHILD))
                        return i;
                    i = i._iNext
            ...
            if (0 !== this._container.children.length) {
                do
                    this._container.children[0].events && this._container.children[0].events.onRemovedFromGroup.dispatch(this._container.children[0], this), this._container.removeChild(this._container.children[0]);
            ...
            if ("undefined" == typeof a && (a = !1), a) {
                if (this._container.children.length > 0)
                    do
                        this._container.children[0].group && this._container.children[0].destroy();
                    while (this._container.children.length > 0)
            } else
                this.removeAll();
            ...
            do {
                if (e > 0) {
                    if (b !== c)
                        return console.log("check next fail"), !1;
                    if (b._iPrev !== d)
        ...
        if (this.camera.target && this.camera.target.postUpdate) {
            if (this.camera.target.postUpdate(), this.camera.update(), this.game.stage._stage.first._iNext) {
                var a = this.game.stage._stage.first._iNext;
                do
                    a.postUpdate && a !== this.camera.target && a.postUpdate(), a = a._iNext;
                while (a != this.game.stage._stage.last._iNext)
            }
        ...
        return this._onBoot = function() {
            ...
            if (this.renderType == c.WEBGL ? b = "WebGL" : this.renderType == c.HEADLESS && (b = "Headless"), this.device.webAudio && (d = "WebAudio"), this.device.chrome) {
                ...
                console.log("Phaser v" + a + " - Renderer: " + b + " - Audio: " + d)
            ...
            if (this.renderType === c.HEADLESS || this.renderType === c.CANVAS || this.renderType === c.AUTO && this.device.webGL === !1) {
                ...
                this.renderType = c.WEBGL, this.renderer = new b.WebGLRenderer(this.width, this.height, this.stage.canvas, this.transparent, this.antialias), this.canvas = this.renderer.view, this.context = null;
        ...
        this.game = a, this.id = b, this._holdSent = !1, this._history = [], this._nextDrop = 0, this._stateReset = !1, this.withinGame = !1, this.clientX = -1, this.clientY = -1, this.pageX = -1, this.pageY = -1, this.screenX = -1, this.screenY = -1, this.x = -1, this.y = -1, this.isMouse = !1, this.isDown = !1, this.isUp = !0, this.timeDown = 0, this.timeUp = 0, this.previousTapTime = 0, this.totalTouches = 0, this.msSinceLastClick = Number.MAX_VALUE, this.targetObject = null, this.active = !1, this.position = new c.Point, this.positionDown = new c.Point, this.circle = new c.Circle(0, 0, 44), 0 === b && (this.isMouse = !0)
            ...
            if (!this.game.input.pollLocked) {
                if ("undefined" != typeof a.button && (this.button = a.button), this.clientX = a.clientX, this.clientY = a.clientY, this.pageX = a.pageX, this.pageY = a.pageY, this.screenX = a.screenX, this.screenY = a.screenY, this.x = (this.pageX - this.game.stage.offset.x) * this.game.input.scale.x, this.y = (this.pageY - this.game.stage.offset.y) * this.game.input.scale.y, this.position.setTo(this.x, this.y), this.circle.x = this.x, this.circle.y = this.y, (this.game.input.multiInputOverride == c.Input.MOUSE_OVERRIDES_TOUCH || this.game.input.multiInputOverride == c.Input.MOUSE_TOUCH_COMBINE || this.game.input.multiInputOverride == c.Input.TOUCH_OVERRIDES_MOUSE && 0 === this.game.input.currentPointers) && (this.game.input.activePointer = this, this.game.input.x = this.x, this.game.input.y = this.y, this.game.input.position.setTo(this.game.input.x, this.game.input.y), this.game.input.circle.x = this.game.input.x, this.game.input.circle.y = this.game.input.y), this.game.paused)
                    return this;
        ...
        this.sprite = a, this.game = a.game, this.enabled = !1, this.priorityID = 0, this.useHandCursor = !1, this.isDragged = !1, this.allowHorizontalDrag = !0, this.allowVerticalDrag = !0, this.bringToTop = !1, this.snapOffset = null, this.snapOnDrag = !1, this.snapOnRelease = !1, this.snapX = 0, this.snapY = 0, this.snapOffsetX = 0, this.snapOffsetY = 0, this.pixelPerfect = !1, this.pixelPerfectAlpha = 255, this.draggable = !1, this.boundsRect = null, this.boundsSprite = null, this.consumePointerEvent = !1, this._tempPoint = new c.Point, this._pointerData = [], this._pointerData.push({id: 0, x: 0, y: 0, isDown: !1, isUp: !1, isOver: !1, isOut: !1, timeOver: 0, timeOut: 0, timeDown: 0, timeUp: 0, downDuration: 0, isDragged: !1})
            ...
            if (a = a || 0, "undefined" == typeof b && (b = !1), this.enabled === !1) {
                ...
                for (var d = 0; 10 > d; d++)
                    this._pointerData[d] = {id: d, x: 0, y: 0, isDown: !1, isUp: !1, isOver: !1, isOut: !1, timeOver: 0, timeOut: 0, timeDown: 0, timeUp: 0, downDuration: 0, isDragged: !1};
            ...
            this.enabled = !1;
            for (var a = 0; 10 > a; a++)
                this._pointerData[a] = {id: a, x: 0, y: 0, isDown: !1, isUp: !1, isOver: !1, isOut: !1, timeOver: 0, timeOut: 0, timeDown: 0, timeUp: 0, downDuration: 0, isDragged: !1}
        }, stop: function() {
            ...
            if (this.sprite.texture.baseTexture.source) {
                ...
                if (c.data[3] >= this.pixelPerfectAlpha)
                    return!0
            }
            return!1
        }, update: function(a) {
        ...
        "undefined" == typeof d && (d = 256), "undefined" == typeof e && (e = 256), this.game = a, this.name = "", this.width = d, this.height = e, this.canvas = c.Canvas.create(d, e), this.context = this.canvas.getContext("2d"), this.imageData = this.context.getImageData(0, 0, d, e), this.pixels = this.imageData.data.buffer ? this.imageData.data.buffer : this.imageData.data, this.baseTexture = new b.BaseTexture(this.canvas), this.texture = new b.Texture(this.baseTexture), this.textureFrame = new c.Frame(0, 0, 0, d, e, "bitmapData", a.rnd.uuid()), this.type = c.BITMAPDATA, this._dirty = !1
            ...
            for (var g = this.createLinearGradient(c, d, e, f), h = 0, i = a.length; i > h; h++)
            ...
            for (var i = this.createRadialGradient(c, d, e, f, g, h), j = 0, k = a.length; k > j; j++)
        ...
        for (var b = ["ms", "moz", "webkit", "o"], c = 0; c < b.length && !window.requestAnimationFrame; c++)
            window.requestAnimationFrame = window[b[c] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[b[c] + "CancelAnimationFrame"];
        ...
        "undefined" == typeof a && (a = []), this.c = 1, this.s0 = 0, this.s1 = 0, this.s2 = 0, this.sow(a)
            ...
            for (var b, c = 0; b = a[c++]; )
                this.s0 -= this.hash(b), this.s0 += ~~(this.s0 < 0), this.s1 -= this.hash(b), this.s1 += ~~(this.s1 < 0), this.s2 -= this.hash(b), this.s2 += ~~(this.s2 < 0)
        }, hash: function(a) {
            var b, c, d;
        ...
        if (g.x = (j * m - k * l) / n, g.y = (i * l - h * m) / n, f) {
            if (Math.pow(g.x - b.x + (g.y - b.y), 2) > Math.pow(a.x - b.x + (a.y - b.y), 2))
                return null;
            if (Math.pow(g.x - a.x + (g.y - a.y), 2) > Math.pow(a.x - b.x + (a.y - b.y), 2))
                return null;
            if (Math.pow(g.x - e.x + (g.y - e.y), 2) > Math.pow(d.x - e.x + (d.y - e.y), 2))
                return null;
            if (Math.pow(g.x - d.x + (g.y - d.y), 2) > Math.pow(d.x - e.x + (d.y - e.y), 2))
                return null
        }
        return g
        ...
        this.game = a, this._tweens = [], this._add = [], this.game.onPause.add(this.pauseAll, this), this.game.onResume.add(this.resumeAll, this)
            ...
            for (var a = 0, b = this._tweens.length; b > a; )
                this._tweens[a].update(this.game.time.now) ? a++ : (this._tweens.splice(a, 1), b--);
        ...
        for (var d in a)
            this._valuesStart[d] = parseFloat(a[d], 10);
        ...
        "undefined" == typeof b && (b = !0), this.game = a, this.running = !1, this.autoDestroy = b, this.expired = !1, this.events = [], this.onComplete = new c.Signal, this.nextTick = 0, this.paused = !1, this._started = 0, this._pauseStarted = 0, this._now = 0, this._len = 0, this._i = 0
            ...
            if (this.paused)
                return!0;
            for (this._now = a - this._started, this._len = this.events.length, this._i = 0; this._i < this._len; )
            ...
            if (this.running && !this.expired) {
                for (var a = this.game.time.now - this._pauseStarted, b = 0; b < this.events.length; b++)
        ...
        this.sprite = a, this.game = a.game, this.currentFrame = null, this.updateIfVisible = !0, this.isLoaded = !1, this._frameData = null, this._anims = {}, this._outputFrames = []
            ...
            if (this._anims[a]) {
                if (this.currentAnim != this._anims[a])
                    return this.currentAnim = this._anims[a], this.currentAnim.paused = !1, this.currentAnim.play(b, c, d);
                if (this.currentAnim.isPlaying === !1)
                    return this.currentAnim.paused = !1, this.currentAnim.play(b, c, d)
            }
        }, stop: function(a, b) {
        ...
        this._frames = [], this._frameNames = []
            ...
            if (-1 !== g && (o = g), 0 === k || 0 === l || e > k || f > l || 0 === o)
            ...
            if (!d.frames)
                return console.warn("Phaser.AnimationParser.JSONData: Invalid Texture Atlas JSON given, missing 'frames' array"), console.log(d), void 0;
            ...
            if (!d.frames)
                return console.warn("Phaser.AnimationParser.JSONDataHash: Invalid Texture Atlas JSON given, missing 'frames' object"), console.log(d), void 0;
            ...
            if (!d.getElementsByTagName("TextureAtlas"))
                return console.warn("Phaser.AnimationParser.XMLData: Invalid Texture Atlas XML given, missing <TextureAtlas> tag"), void 0;
            for (var f, g, h, i, j, k, l, m, n, o, p, q, r = new c.FrameData, s = d.getElementsByTagName("SubTexture"), t = 0; t < s.length; t++)
        ...
        this.game = a, this._canvases = {}, this._images = {}, this._textures = {}, this._sounds = {}, this._text = {}, this._tilemaps = {}, this._binary = {}, this._bitmapDatas = {}, this.addDefaultImage(), this.addMissingImage(), this.onSoundUnlock = new c.Signal
            ...
            for (var a in this._canvases)
                delete this._canvases[a.key];
            for (var a in this._images)
                delete this._images[a.key];
            for (var a in this._sounds)
                delete this._sounds[a.key];
            for (var a in this._text)
                delete this._text[a.key]
        ...
        this.game = a, this._fileList = [], this._fileIndex = 0, this._progressChunk = 0, this._xhr = new XMLHttpRequest, this.isLoading = !1, this.hasLoaded = !1, this.progress = 0, this.progressFloat = 0, this.preloadSprite = null, this.crossOrigin = "", this.baseURL = "", this.onFileComplete = new c.Signal, this.onFileError = new c.Signal, this.onLoadStart = new c.Signal, this.onLoadComplete = new c.Signal
            ...
            if ("undefined" == typeof b && (b = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = c.Tilemap.CSV), null == b && null == d)
            ...
            if (d) {
                ...
                this.addToFileList("tilemap", a, b, {format: e});
            return this
        }, bitmapFont: function(a, b, c, d) {
            if ("undefined" == typeof c && (c = null), "undefined" == typeof d && (d = null), c)
            ...
            if ("undefined" == typeof d && (d = null), "undefined" == typeof e && (e = null), "undefined" == typeof f && (f = c.Loader.TEXTURE_ATLAS_JSON_ARRAY), d)
                        ...
                        if ("string" == typeof e) {
                            ...
                            try {
                                if (window.DOMParser) {
                                    ...
                                    g = new ActiveXObject("Microsoft.XMLDOM"), g.async = "false", g.loadXML(e)
                            } catch (i) {
                                g = void 0
                            }
            ...
            if (!this._fileList[this._fileIndex])
                return console.warn("Phaser.Loader loadFile invalid index " + this._fileIndex), void 0;
            ...
            switch (a.type) {
                ...
                case"audio":
                    ...
                    break;
                case"tilemap":
                    if (this._xhr.open("GET", this.baseURL + a.url, !0), this._xhr.responseType = "text", a.format === c.Tilemap.TILED_JSON)
            ...
            "string" == typeof a && (a = [a]);
            for (var c = 0; c < a.length; c++)
                if (b = a[c].toLowerCase(), b = b.substr((Math.max(0, b.lastIndexOf(".")) || 1 / 0) + 1), this.game.device.canPlayAudio(b))
                    return a[c];
            return null
            ...
            if (!this._fileList[a])
                return console.warn("Phaser.Loader fileComplete invalid index " + a), void 0;
            ...
            switch (b.type) {
                ...
                case"textureatlas":
                    if (null == b.atlasURL)
                        ...
                        if (d = !1, this._xhr.open("GET", this.baseURL + b.atlasURL, !0), this._xhr.responseType = "text", b.format == c.Loader.TEXTURE_ATLAS_JSON_ARRAY || b.format == c.Loader.TEXTURE_ATLAS_JSON_HASH)
                            this._xhr.onload = function() {
                                return e.jsonLoadComplete(a)
                            };
                        else {
                            if (b.format != c.Loader.TEXTURE_ATLAS_XML_STARLING)
                                throw new Error("Phaser.Loader. Invalid Texture Atlas format: " + b.format);
                            this._xhr.onload = function() {
                ...
                case"audio":
                    if (this.game.sound.usingWebAudio) {
                        ...
                        b.data.removeEventListener("canplaythrough", c.GAMES[this.game.id].load.fileComplete), this.game.cache.addSound(b.key, b.url, b.data, !1, !0);
                    break;
                case"text":
            ...
            if (!this._fileList[a])
                return console.warn("Phaser.Loader jsonLoadComplete invalid index " + a), void 0;
            ...
            if (!this._fileList[a])
                return console.warn("Phaser.Loader csvLoadComplete invalid index " + a), void 0;
            ...
            try {
                if (window.DOMParser) {
                    ...
                    b = new ActiveXObject("Microsoft.XMLDOM"), b.async = "false", b.loadXML(c)
            } catch (e) {
                b = void 0
            }
            ...
            if (!c.getElementsByTagName("font"))
                return console.warn("Phaser.LoaderParser.bitmapFont: Invalid XML given, missing <font> tag"), void 0;
        ...
        "undefined" == typeof d && (d = 1), "undefined" == typeof e && (e = !1), "undefined" == typeof f && (f = a.sound.connectToMaster), this.game = a, this.name = b, this.key = b, this.loop = e, this._volume = d, this.markers = {}, this.context = null, this._buffer = null, this._muted = !1, this.autoplay = !1, this.totalDuration = 0, this.startTime = 0, this.currentTime = 0, this.duration = 0, this.stopTime = 0, this.paused = !1, this.pausedPosition = 0, this.pausedTime = 0, this.isPlaying = !1, this.currentMarker = "", this.pendingPlayback = !1, this.override = !1, this.usingWebAudio = this.game.sound.usingWebAudio, this.usingAudioTag = this.game.sound.usingAudioTag, this.externalNode = null, this.usingWebAudio ? (this.context = this.game.sound.context, this.masterGainNode = this.game.sound.masterGain, this.gainNode = "undefined" == typeof this.context.createGain ? this.context.createGainNode() : this.context.createGain(), this.gainNode.gain.value = d * this.game.sound.volume, f && this.gainNode.connect(this.masterGainNode)) : this.game.cache.getSound(b) && this.game.cache.isSoundReady(b) ? (this._sound = this.game.cache.getSoundData(b), this.totalDuration = 0, this._sound.duration && (this.totalDuration = this._sound.duration)) : this.game.cache.onSoundUnlock.add(this.soundHasUnlocked, this), this.onDecoded = new c.Signal, this.onPlay = new c.Signal, this.onPause = new c.Signal, this.onResume = new c.Signal, this.onLoop = new c.Signal, this.onStop = new c.Signal, this.onMute = new c.Signal, this.onMarkerComplete = new c.Signal
            ...
            if (a = a || "", b = b || 0, "undefined" == typeof c && (c = this._volume), "undefined" == typeof d && (d = !1), "undefined" == typeof e && (e = !0), this.isPlaying !== !0 || e !== !1 || this.override !== !1) {
                if (this.isPlaying && this.override && (this.usingWebAudio ? "undefined" == typeof this._sound.stop ? this._sound.noteOff(0) : this._sound.stop(0) : this.usingAudioTag && (this._sound.pause(), this._sound.currentTime = 0)), this.currentMarker = a, "" !== a) {
                    if (!this.markers[a])
                        return console.warn("Phaser.Sound.play: audio marker " + a + " doesn't exist"), void 0;
                    ...
                    this.position = b, this.volume = c, this.loop = d, this.duration = 0, this.durationMS = 0, this._tempMarker = a, this._tempPosition = b, this._tempVolume = c, this._tempLoop = d;
        ...
        this.game = a, this.onSoundDecode = new c.Signal, this._muted = !1, this._unlockSource = null, this._volume = 1, this._sounds = [], this.context = null, this.usingWebAudio = !0, this.usingAudioTag = !1, this.noAudio = !1, this.connectToMaster = !0, this.touchLocked = !1, this.channels = 32
            ...
            if (this.game.device.iOS && this.game.device.webAudio === !1 && (this.channels = 1), this.game.device.iOS || window.PhaserGlobal && window.PhaserGlobal.fakeiOSTouchLock ? (this.game.input.touch.callbackContext = this, this.game.input.touch.touchStartCallback = this.unlock, this.game.input.mouse.callbackContext = this, this.game.input.mouse.mouseDownCallback = this.unlock, this.touchLocked = !0) : this.touchLocked = !1, window.PhaserGlobal) {
                ...
                if (window.PhaserGlobal.disableWebAudio === !0)
                    return this.usingWebAudio = !1, this.usingAudioTag = !0, this.noAudio = !1, void 0
            }
        ...
        this.game = a, this.context = a.context, this.font = "14px Courier", this.columnWidth = 100, this.lineHeight = 16, this.renderShadow = !0, this.currentX = 0, this.currentY = 0, this.currentAlpha = 1
            ...
            if (null !== this.context || null !== d) {
                ...
                if (a.type === c.Physics.Arcade.CIRCLE)
                    this.start(0, 0, b), this.context.beginPath(), this.context.strokeStyle = b, this.context.arc(e, f, a.shape.r, 0, 2 * Math.PI, !1), this.context.stroke(), this.context.closePath(), this.stop();
                else {
                    ...
                    for (var h = 1; h < g.length; h++)
                        this.context.fillStyle = "rgb(255," + 40 * h + ",0)", this.context.fillRect(e + g[h].x - 2, f + g[h].y - 2, 5, 5);
                    this.stop()
                }
            }
            ...
            if ("undefined" == typeof a && (a = 0), "undefined" == typeof b && (b = 255), "undefined" == typeof d && (d = 255), b > 255)
    ...
    var f = function() {
        ...
        function g(a, b, c, d, e, g) {
            ...
            if (f(c, e, h), f(d, e, i), i[0] += k, i[1] += k, h[0] > i[1] || i[0] > h[1])
            ...
            for (var d = n.pop().copy(b.pos).sub(a.pos), e = b.r, f = e * e, g = a.points, i = g.length, j = n.pop(), k = n.pop(), l = 0; i > l; l++) {
                ...
                if (t === q) {
                    ...
                    if (j.copy(a.edges[m]), k.copy(d).sub(g[m]), t = h(j, k), t === q) {
                        var v = k.len();
                        if (v > e)
                            return n.push(d), n.push(j), n.push(k), !1;
                        c && (c.bInA = !1, r = k.normalize(), p = e - v)
                    }
                } else {
                    var w = j.perp().normalize(), v = k.dot(w), x = Math.abs(v);
                    if (v > 0 && x > e)
                        return n.push(d), n.push(w), n.push(k), !1;
        ...
        function l(a, b, c) {
            for (var d = a.points, e = d.length, f = b.points, h = f.length, i = 0; e > i; i++)
                if (g(a.pos, b.pos, d, f, a.normals[i], c))
                    return!1;
            for (var i = 0; h > i; i++)
                if (g(a.pos, b.pos, d, f, b.normals[i], c))
                    return!1;
        ...
        m.Vector = a, m.V = a, a.prototype.copy = a.prototype.copy = function(a) {
            ...
            for (b = 0; f > b; b++)
                c[b].rotatePrecalc(h, g), d[b].rotatePrecalc(h, g), e[b].rotatePrecalc(h, g);
            return this
    ...
    return c.Physics = {}, c.Physics.Arcade = function(a) {
        this.game = a, this.gravity = new c.Point, this.worldLeft = null, this.worldRight = null, this.worldTop = null, this.worldBottom = null, this.worldPolys = [null, null, null, null], this.quadTree = new c.QuadTree(this.game.world.bounds.x, this.game.world.bounds.y, this.game.world.bounds.width, this.game.world.bounds.height, this.maxObjects, this.maxLevels), this.maxObjects = 10, this.maxLevels = 4, this._mapData = [], this._mapTiles = 0, this._result = !1, this._total = 0, this._angle = 0, this._drag = 0, this._dx = 0, this._dy = 0, this._p = new c.Point(0, 0), this._intersection = [0, 0, 0, 0], this._gravityX = 0, this._gravityY = 0, this._response = new f.Response, this.setBoundsToWorld(!0, !0, !0, !0)
            ...
            if (!a.collideWorldBounds || !this.worldLeft && !this.worldRight && !this.worldTop && !this.worldBottom)
                return!1;
            ...
            if (0 !== b.length) {
                ...
                for (var h = 0, i = this._potentials.length; i > h; h++)
                    this.separate(a.body, this._potentials[h], e, f, g) && (d && d.call(f, a, this._potentials[h].sprite), this._total++)
            }
        }, collideGroupVsSelf: function(a, b, c, d, e) {
            if (0 !== a.length)
                for (var f = a._container.children.length, g = 0; f > g; g++)
                    for (var h = g + 1; f >= h; h++)
                        a._container.children[g] && a._container.children[h] && a._container.children[g].exists && a._container.children[h].exists && this.collideSpriteVsSprite(a._container.children[g], a._container.children[h], b, c, d, e)
            ...
            if (0 !== a.length && 0 !== b.length && a._container.first._iNext) {
                ...
                do
                    g.exists && this.collideSpriteVsGroup(g, b, c, d, e, f), g = g._iNext;
            ...
            if (this._mapData = b.getTiles(a.body.left, a.body.top, a.body.width, a.body.height, !0), 0 !== this._mapData.length)
                if (this._mapData.length > 1)
                    this.separateTiles(a.body, this._mapData);
                else {
                    var f = 0;
            ...
            if (0 !== a.length && a._container.first._iNext) {
                ...
                do
                    f.exists && this.collideSpriteVsTilemapLayer(f, b, c, d, e), f = f._iNext;
            ...
            for (var c, d = !1, e = 0; e < b.length; e++)
                c = b[e], this.separateTile(a, c) && (d = !0);
            return d
        }, separateTile: function(a, b) {
            if (this._intersection = this.tileIntersects(a, b), 0 === this._intersection[4] || 0 === this._intersection[2] || 0 === this._intersection[3])
                return!1;
            if (b.tile.callback || b.layer.callbacks[b.tile.index]) {
                if (b.tile.callback && b.tile.callback.call(b.tile.callbackContext, a.sprite, b) === !1)
                    return!1;
                if (b.layer.callbacks[b.tile.index] && b.layer.callbacks[b.tile.index].callback.call(b.layer.callbacks[b.tile.index].callbackContext, a.sprite, b) === !1)
                    return!1
            }
        ...
        this.sprite = a, this.game = a.game, this.offset = new c.Point, this.preX = a.world.x, this.preY = a.world.y, this.preRotation = a.angle, this.velocity = new c.Point, this.acceleration = new c.Point, this.speed = 0, this.angle = 0, this.gravity = new c.Point, this.bounce = new c.Point, this.minVelocity = new c.Point, this.maxVelocity = new c.Point(1e3, 1e3), this.angularVelocity = 0, this.angularAcceleration = 0, this.angularDrag = 0, this.maxAngular = 1e3, this.mass = 1, this.linearDamping = 0, this.checkCollision = {none: !1, any: !0, up: !0, down: !0, left: !0, right: !0}, this.touching = {none: !0, up: !1, down: !1, left: !1, right: !1}, this.blocked = {x: 0, y: 0, up: !1, down: !1, left: !1, right: !1}, this.facing = c.NONE, this.rebound = !0, this.immovable = !1, this.moves = !0, this.rotation = 0, this.allowRotation = !0, this.allowGravity = !0, this.customSeparateCallback = null, this.customSeparateContext = null, this.collideCallback = null, this.collideCallbackContext = null, this.collideWorldBounds = !1, this.type = c.Physics.Arcade.RECT, this.shape = null, this.polygon = null, this.left = 0, this.right = 0, this.top = 0, this.bottom = 0, this.width = 0, this.height = 0, this.contacts = [], this.overlapX = 0, this.overlapY = 0, this._temp = null, this._dx = 0, this._dy = 0, this._sx = a.scale.x, this._sy = a.scale.y, this._distances = [0, 0, 0, 0], this._vx = 0, this._vy = 0, this.setRectangle(a.width, a.height, 0, 0), this.sprite.events.onBeginContact = new c.Signal, this.sprite.events.onEndContact = new c.Signal
            ...
            if (this.mass === a.mass && this.speed > 0 && a.speed > 0)
                this._dx = a.velocity.x, this._dy = a.velocity.y, a.velocity.x = this.velocity.x * a.bounce.x, a.velocity.y = this.velocity.y * a.bounce.x, this.velocity.x = this._dx * this.bounce.x, this.velocity.y = this._dy * this.bounce.y;
            else {
            ...
            if (this._distances[0] = a.right - this.x, this._distances[1] = this.right - a.x, this._distances[2] = a.bottom - this.y, this._distances[3] = this.bottom - a.y, !b.overlapN.x || 0 !== this._distances[0] && 0 !== this._distances[1] ? !b.overlapN.y || 0 !== this._distances[2] && 0 !== this._distances[3] || (b.overlapN.x = !0, b.overlapN.y = !1) : (b.overlapN.x = !1, b.overlapN.y = !0), this.customSeparateCallback)
                return this.customSeparateCallback.call(this.customSeparateContext, this, b, this._distances);
            var c = !1;
        ...
        null !== d && (this.width = d.width, this.height = d.height, this.tileWidth = d.tileWidth, this.tileHeight = d.tileHeight, this.orientation = d.orientation, this.version = d.version, this.properties = d.properties, this.widthInPixels = d.widthInPixels, this.heightInPixels = d.heightInPixels, this.layers = d.layers, this.tilesets = d.tilesets, this.tiles = d.tiles, this.objects = d.objects, this.images = d.images, this.currentLayer = 0, this.debugMap = [], this._results = [], this._tempA = 0, this._tempB = 0)
            ...
            if ("undefined" == typeof e && (e = !0), "undefined" == typeof f && (f = !0), "undefined" == typeof g && (g = this.game.world), !this.objects[a])
                return console.warn("Tilemap.createFromObjects: Invalid objectgroup name given: " + a), void 0;
            for (var h, i = 0, j = this.objects[a].length; j > i; i++)
                if (this.objects[a][i].gid === b) {
                    ...
                    for (property in this.objects[a][i].properties)
                        g.set(h, property, this.objects[a][i].properties[property], !1, !1, 0)
                }
            ...
            if (d = this.getLayer(d), "number" == typeof a)
                this.layers[d].callbacks[a] = {callback: b, callbackContext: c};
            else
                for (var e = 0, f = a.length; f > e; e++)
                    this.layers[d].callbacks[a[e]] = {callback: b, callbackContext: c}
            ...
            if ("undefined" == typeof b && (b = !0), c = this.getLayer(c), "number" == typeof a)
        ...
        for (var a = this._startY, b = this._startY + this._maxY; b > a; a++) {
            ...
            if (null === k)
                return console.warn("Phaser.TilemapParser.tileSet: Invalid image key given"), null;
            ...
            for (var d = [], e = 0; e < a.layers.length; e++)
                if ("tilelayer" === a.layers[e].type) {
                    ...
                    for (var g = 0, h = [], i = [], j = 0, k = a.layers[e].data.length; k > j; j++)
                        a.layers[e].data[j] > 0 ? h.push(new c.Tile(f, a.layers[e].data[j], g, i.length, a.tilewidth, a.tileheight)) : h.push(null), g++, g === a.layers[e].width && (i.push(h), g = 0, h = []);
                    f.data = i, d.push(f)
                }
            b.layers = d;
        ...
        for (var a, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = 0, s = this.head; s; ) {
            if (s.vcount === b.visibleCount) {
                ...
                k = 8 * r, this.verticies[k + 0] = 0, this.verticies[k + 1] = 0, this.verticies[k + 2] = 0, this.verticies[k + 3] = 0, this.verticies[k + 4] = 0, this.verticies[k + 5] = 0, this.verticies[k + 6] = 0, this.verticies[k + 7] = 0;
            r++, s = s.__next
        }
    }, c
});
